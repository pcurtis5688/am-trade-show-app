...
public class SpecialEventSales extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home_btn) {
            ...
            Intent makeReservationIntent = new Intent(specialEventSalesActivityContext, BoothReservationShowSelection.class);
            ...
            Intent applicationSettingsIntent = new Intent(specialEventSalesActivityContext, ApplicationSettings.class);
