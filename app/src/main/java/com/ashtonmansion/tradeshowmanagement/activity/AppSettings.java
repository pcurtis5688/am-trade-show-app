...
public class AppSettings extends AppCompatActivity
    ...
    private Context appSettingsActivityContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar appSettingsToolbar = (Toolbar) findViewById(R.id.app_settings_toolbar);
        setSupportActionBar(appSettingsToolbar);

        DrawerLayout navDrawer = (DrawerLayout) findViewById(R.id.app_settings_drawerlayout);
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, navDrawer, appSettingsToolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
        navDrawer.setDrawerListener(toggle);
        toggle.syncState();

        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view_app_settings);
        navigationView.setNavigationItemSelectedListener(this);

        ///////////DATA WORK////////////////////////////////////
        appSettingsActivityContext = this;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home_btn) {
            Intent homeIntent = new Intent(appSettingsActivityContext, HomeActivity.class);
            startActivity(homeIntent);
        } else if (id == R.id.nav_show_setup_btn) {
            Intent showSetupIntent = new Intent(appSettingsActivityContext, ShowSetup.class);
            ...
            Intent makeReservationIntent = new Intent(appSettingsActivityContext, MakeReservation.class);
            startActivity(makeReservationIntent);
        } else if (id == R.id.nav_email_reservation_confirmation_btn) {
            Intent emailConfirmationIntent = new Intent(appSettingsActivityContext, EmailConfirmation.class);
            startActivity(emailConfirmationIntent);
        } else if (id == R.id.nav_advertising_sales_btn) {
            Intent advertisingSalesIntent = new Intent(appSettingsActivityContext, AdvertisingSales.class);
            startActivity(advertisingSalesIntent);
        } else if (id == R.id.nav_general_tix_sales_btn) {
            Intent generalTicketSalesIntent = new Intent(appSettingsActivityContext, GeneralTicketSales.class);
            startActivity(generalTicketSalesIntent);
        } else if (id == R.id.nav_special_events_sales_btn) {
            Intent specialEventSalesIntent = new Intent(appSettingsActivityContext, SpecialEventSales.class);
            startActivity(specialEventSalesIntent);
        } else if (id == R.id.nav_merchandise_sales_btn) {
            Intent merchandiseSalesIntent = new Intent(appSettingsActivityContext, MerchandiseSales.class);
